================================================================================
  ONE-FILE BUNDLE — on VPS: save this file, run:  node unbundle.js THIS_FILENAME.txt
  Then: npm ci --omit=dev && cp env.example .env && nano .env && npm start
  Each section: ### FILE: relative/path ###
================================================================================
...
### FILE: package.json ###
{
  ...
  "version": "1.0.0",
  "private": true,
  "description": "Socket.IO match server for ChessApp (deploy on Hostinger VPS or similar)",
  "scripts": {
    "start": "node index.js",
    "dev": "node index.js"
  },
